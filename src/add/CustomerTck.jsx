  ...
  return (
    <div className="md:max-w-11/12 mx-auto flex md:flex-row flex-col gap-7">
      ...
      <div className="md:w-3/12 space-y-5">
        ...
        {
          btnProgress && btnProgress.length > 0 ? (<div className="grid md:grid-cols-1 grid-cols-2 gap-3">
        ...
        </div>): <p className="text-sm italic text-gray-500 text-center">No Task In-Progress</p>
        }
        ...
        <div className="space-y-3 mt-7">
          ...
          <div className="grid md:grid-cols-1 grid-cols-2 gap-3">
            {
              resolved.length>0 ? resolved.map((item)=> (<ResolvedTask addResolve={item}></ResolvedTask>)): <p className="text-sm text-gray-500 italic text-center">No Resolved Task are here.</p>
            }
          </div>
        </div>
      </div>
